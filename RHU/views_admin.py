...
from RHU.forms import EmployeeRegisterForm
from RHU.models import Account, Profile, Action
from RHU.models import Statistics
...
def users_view(request):
    ...
    return render(request, 'Thesis/admin/users.html', template_data)
...
def activity_view(request):
    ...
    return render(request, 'Thesis/admin/activity.html', template_data)
...
def statistic_view(request):
   # Authentication check.
    ...
    if 'sort' in request.GET:
        ...
        if request.GET['sort'] == 'type':
            template_data['query'] = Action.objects.all().order_by('type', 'description', '-timePerformed')
    return render(request, 'Thesis/admin/stats.html', template_data)
...
def createemployee_view(request):
    ...
    return render(request, 'Thesis/admin/createemployee.html', template_data)    